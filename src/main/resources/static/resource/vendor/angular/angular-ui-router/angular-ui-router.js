...
function $Resolve(  $q,    $injector) {
   ...
   * be a component name to be passed to `$injector.get()`. This is supported primarily
...
//  function regexpMatches(val) { /*jshint validthis:true */ return isDefined(val) && this.pattern.test(val); }
   ...
   *
   * <pre>
   * // Defines a custom type that gets a value from a component,
   * // where each component gets different types of values from
   * // a backend API:
   ...
   *       // name (key) to call the correct component
...
function $UrlRouterProvider(   $locationProvider,   $urlMatcherFactory) {
   ...
   *     // UserService is an example component for managing user state
...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory) {
   ...
   *   - factory - {string|function}: If string then it is alias for component. Otherwise if function,
   ...
   *   transitioned to, the `$stateParams` component will be populated with any
   ...
   *
   * @description
   * `$state` component is responsible for representing states as well as transitioning
 ...
 *
 * @description
 * Provider that returns the {@link ui.router.state.$uiViewScroll} component function.
 */
function $ViewScrollProvider() {
   ...
   *
   * @description
   * Reverts back to using the core [`$anchorScroll`](http://docs.angularjs.org/api/ng.$anchorScroll) component for
 ...
 * component, {@link ui.router.state.$uiViewScroll}. This custom component let's you
